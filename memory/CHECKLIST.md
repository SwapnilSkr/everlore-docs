...
- [x] Choice POV drift: tap-to-play choices conflate viewpoints (e.g. "The
      ...
      (Server commit `dbc1cf5`. Root cause: choices are generated by the
      ...
      docstring refreshed. `npx tsc --noEmit` clean. NOT yet run against a live
      generated turn — verify on a real playthrough.)
